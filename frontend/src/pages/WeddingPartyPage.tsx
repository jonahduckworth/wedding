...
export default function WeddingPartyPage() {
  ...
  return (
    <Layout>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {bridalParty.map((person, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-cream/50 rounded-3xl p-8 border-2 border-dusty-rose/20 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                  {/* Photo placeholder */}
                  <div className="aspect-square bg-gradient-to-br from-blush/40 to-sage/40 rounded-2xl mb-6 flex items-center justify-center border-2 border-dusty-rose/20 overflow-hidden">
                    <span className="text-6xl">👰</span>
                  </div>

                  {/* Name & Role */}
                  <div className="mb-4">
                    <h3 className="font-display text-3xl mb-1 text-charcoal">
                      {person.name}
                    </h3>
                  ...
                  {/* Bio */}
                  <p className="text-warm-gray leading-relaxed font-light text-sm">
                    {person.bio}
                  </p>
                </div>
              </motion.div>
      ...
      {/* Divider */}
      <div className="py-12 bg-gradient-to-b from-off-white to-cream flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {groomsmen.map((person, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-off-white rounded-2xl p-6 border-2 border-sage/20 shadow-lg hover:shadow-xl transition-all duration-300 text-center h-full">
                  {/* Photo placeholder */}
                  <div className="aspect-square bg-gradient-to-br from-sage/40 to-terracotta/40 rounded-xl mb-4 flex items-center justify-center border-2 border-sage/20 overflow-hidden">
                    <span className="text-5xl">🤵</span>
                  </div>

                  {/* Name & Role */}
                  <h3 className="font-display text-xl mb-1 text-charcoal">
                    {person.name}
                  </h3>
